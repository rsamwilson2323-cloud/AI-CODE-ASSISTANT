...
function SpaceComplexity({ onBack }) {
  ...
  const handleAnalyze = async () => {
    ...
    setLoading(true);
    setAnalysis("🔄 Analyzing space complexity...");

    try {
      const res = await window.puter.ai.chat(`
Analyze the space complexity of this code. Explain in simple terms:
1. What is the space complexity (Big O)?
2. Why is it that complexity?
3. What memory is being used?
...
${code}
  ...
  return (
    ...
    <button
        ...
        <h1 className="text-3xl md:text-4xl font-extrabold bg-linear-to-r from-orange-400 to-red-400 bg-clip-text">
          💾 Space Complexity
        </h1>
      ...
      <div className="flex gap-4 mb-6">
        ...
        >
          ...
          {loading ? "Analyzing..." : "Analyze Memory Usage"}
        </button>
      </div>
